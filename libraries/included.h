    ...
    #define get_name_info(this_address, buff, buff_size) (getnameinfo(this_address->Address.lpSockaddr, this_address->Address.lpSockaddrLength, buff, buff_size, 0, 0, NI_NUMERICHOST))
